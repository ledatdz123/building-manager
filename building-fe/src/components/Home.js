                ...
                <a href="/floors">
                    <div class="jp_top_jobs_category_wrapper  ">
                        <div class="jp_top_jobs_category">
                            ...
                            <p>Module được thực hiện bởi Quang - N18DCCN159, cho phép quản lý danh sách các tầng, thông tin về các mặt bằng đã được thuê tại mỗi tầng,
                ...
                <a href="/company">
                    <div class="jp_top_jobs_category_wrapper jp_top_clr_category_wrapper ">
                        <div class="jp_top_jobs_category">
                            ...
                            <p>Thực hiện bởi Dat- D18DCCN036, cho phép quản lý danh sách các công ty thuê mặt bằng trong tòa nhà cũng như quản lý các nhân viên của công ty
                            </p>
                        </div>
                    </div>
                </a>
                <a href="/service-management">
                    <div class="jp_top_jobs_category_wrapper  ">
                        <div class="jp_top_jobs_category">
                            ...
                            <p>Thực hiện bởi Phu cho phép quản lý các đầu mục dịch vụ, mức lương của mỗi đầu mục dịch vụ và
                ...
                <a href="/monthly-fee-statistics">
                    <div class="jp_top_jobs_category_wrapper jp_top_clr_category_wrapper ">
                        <div class="jp_top_jobs_category">
                            ...
                            <p> Thực hiện bởi Dinh cho phép theo dõi số tiền mỗi công ty phải trả trong tháng
